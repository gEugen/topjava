                ...
                .andExpect(model().attribute("meals",
                        new AssertionMatcher<List<MealTo>>() {
                            ...
                            public void assertion(List<MealTo> actual) throws AssertionError {
                                MEAL_TO_MATCHER.assertMatch(getSortedActual(actual), mealTos);
                            }

                            private List<MealTo> getSortedActual(List<MealTo> actual) {
                                return actual == null ? Collections.emptyList() :
                                        actual.stream()
