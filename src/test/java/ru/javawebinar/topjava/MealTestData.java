...
public class MealTestData {
    ...
    public static final MatcherFactory.Matcher<Meal> MEAL_MATCHER_WITH_USER =
            MatcherFactory.usingIgnoringFieldsComparator("user.registered", "user.meals");
    ...
    public static final Meal adminMeal1WithUser = new Meal(ADMIN_MEAL_ID, of(2020, Month.JANUARY, 31, 14, 0), "Админ ланч", 510);
