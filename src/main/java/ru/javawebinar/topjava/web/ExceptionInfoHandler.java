        ...
        if (e instanceof DataIntegrityViolationException) {
            ...
            if (str.contains("users_unique_email_idx") || str.contains("meals_unique_user_datetime_idx")) {
                ...
                if (rootCauseMsg.toLowerCase().contains("users_unique_email_idx")) {
                    details[0] = "[email] " + messageSource.getMessage("common.users_unique_email_idx", null, LOCALE_RU);
                } else {
                    details[0] = "[dateTime] " + messageSource.getMessage("common.meals_unique_user_datetime_idx", null, LOCALE_RU);
                }
            }
        }
